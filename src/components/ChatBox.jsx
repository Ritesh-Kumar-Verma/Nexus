...
const ChatBox = ({activeChat}) => {
  ...
  const chatData = [
  {
    ...
    message: "Hey, did you see the update on the project? The new UI looks clean.",
    time: "10:45 AM",
    date: "2024-05-12",
    isOnline: true,
    unreadCount: 2
  },
  {
    ...
    message: "I've attached the final design specs. Let me know if you need anything else!",
    time: "Yesterday",
    date: "2024-05-11",
    isOnline: false,
    unreadCount: 0
      ...
      {chatData.map((data,index)=>(
        <div key={index} className='flex h-16  items-center gap-3'>
          ...
          <div className=' flex flex-col'>
            <div className='text-[#DCDDDE] font-bold text-md'>{data.username} <span className='text-[#8E9297] text-sm'>{data.time}</span></div>
